...
search_words = "#mitsubishi"      #enter your words, eventually has to accept input
...
read_file = pd.read_csv (r'C:\Users\Hp\Desktop\AmDocs Important\test_file.csv')
read_file.to_excel (r'C:\Users\Hp\Desktop\AmDocs Important\test_file_sheet.xlsx', index=None, header=True)
